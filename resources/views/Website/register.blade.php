                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            ...
                                            <input type='text' name='password' id='password' class="form-control" maxlength="12" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            ...
                                            <input type='text' name='re-password' id='re-password' maxlength="12" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-custom color-2" type="submit">Register</button>
